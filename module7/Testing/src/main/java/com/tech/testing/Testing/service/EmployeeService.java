...
import com.tech.testing.Testing.exceptions.ResourceNotFoundException;
import com.tech.testing.Testing.repository.EmployeeRepository;
...
public class EmployeeService {
    ...
    public EmployeeDTO getEmployeeId(Long id) {
        ...
        EmployeeEntity employeeEntity = employeeRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("Employee id not found"));
