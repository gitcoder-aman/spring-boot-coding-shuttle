 ...
 */
package com.tech.learnKafka.event;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1131365632097341361L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.tech.learnKafka.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public static com.tech.learnKafka.event.UserCreatedEvent.Builder newBuilder() {
    return new com.tech.learnKafka.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.tech.learnKafka.event.UserCreatedEvent.Builder newBuilder(com.tech.learnKafka.event.UserCreatedEvent.Builder other) {
    if (other == null) {
      return new com.tech.learnKafka.event.UserCreatedEvent.Builder();
    } else {
      return new com.tech.learnKafka.event.UserCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.tech.learnKafka.event.UserCreatedEvent.Builder newBuilder(com.tech.learnKafka.event.UserCreatedEvent other) {
    if (other == null) {
      return new com.tech.learnKafka.event.UserCreatedEvent.Builder();
    } else {
      return new com.tech.learnKafka.event.UserCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tech.learnKafka.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tech.learnKafka.event.UserCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech.learnKafka.event.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech.learnKafka.event.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech.learnKafka.event.UserCreatedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech.learnKafka.event.UserCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech.learnKafka.event.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech.learnKafka.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
